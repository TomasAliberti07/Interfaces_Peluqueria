...
class ViewPersonas(tk.Frame):
    ...
    def create_widgets(self):
        ...
        search_frame.grid(row=0, column=0, padx=5, pady=50)
        ...
        self.personas_treeview.heading("domicilio", text="Domicilio")
        self.personas_treeview.heading("ciudad", text="Ciudad")
        self.personas_treeview.heading("instagram", text="Instagram")
        ...
        self.personas_treeview.column("domicilio", anchor='center', width=150)
        self.personas_treeview.column("ciudad", anchor='center', width=150)
        self.personas_treeview.column("instagram", anchor='center', width=150)
